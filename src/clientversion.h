...
//! These need to be macros, as clientversion.cpp's and plexus*-res.rc's voodoo requires it
...
/**
 * plexusd-res.rc includes this file, but it cannot cope with real c++ code.
