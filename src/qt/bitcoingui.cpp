                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(960, 642), this);

    QString windowTitle = tr("Plexus") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Plexus address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Plexus: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Plexus"), this);
    aboutAction->setStatusTip(tr("Show information about Plexus"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Plexus"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Plexus addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Plexus addresses"));
    ...
    openAction->setStatusTip(tr("Open a Plexus: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Plexus help message to get a list with possible Plexus command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Plexus client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Plexus network", "", count));
}
...
{
    QString strTitle = tr("Plexus"); // default title
